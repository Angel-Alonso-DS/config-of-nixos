...

{
  ...
  xdg.configFile."waybar/scripts/system-info-menu.lua" = {
    source = ./waybar/scripts/system-info-menu.lua;
    executable = true;
  };
    xdg.configFile."waybar/scripts/bluetooth-status.lua" = {
  ...
  programs.waybar = {
    ...
    settings = {
      mainBar = {
        ...
        "custom/cputemp" = {
          exec = "sensors coretemp-isa-0000 | awk '/Package id 0/ {print $4}' | tr -d '+°C'";
          interval = 5;
          format = "󱃃 {}°C ";
          format-warning = "󰸃 {}°C ";
          format-critical = "󰸁 {}°C ";
        ...
        "custom/bluetooth" = {
          ...
          interval = 10;
          return-type = "json";
          exec = "lua ~/.config/waybar/scripts/bluetooth-status.lua";
